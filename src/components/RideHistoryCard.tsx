          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5 text-xs text-gray-500 mt-0.5">
                ...
                <span>{ride.passengerPhoneNumber || "No phone listed"}</span>
              </div>
            </div>
          </div>
        ...
        <div className="py-5 space-y-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <h3 className="font-semibold text-xs sm:text-sm text-gray-800">{ride.source}</h3>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <h3 className="font-semibold text-xs sm:text-sm text-gray-800">{ride.destination}</h3>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3 pt-4 border-t border-gray-100 text-center">
          <div className="bg-emerald-50/70 p-3 rounded-xl border border-emerald-100">
            <div className="flex items-center justify-center gap-1 text-[10px] font-bold text-emerald-700 uppercase">
              <FaRupeeSign className="text-xs" /> Fare Earned
            </div>
